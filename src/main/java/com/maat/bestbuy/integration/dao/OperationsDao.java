...
import com.maat.bestbuy.integration.repository.*;
...
public class OperationsDao {
    ...
    private static final Logger LOGGER = LoggerFactory.getLogger(OperationsDao.class);
    ...
    @Autowired
    public OperationsDao(ApplicationsRepository applicationRepository, EnvironmentRepository environmentRepository, InfrastructureMappingRespository infrastructureMappingRespository, ServerTypeRepository serverTypeRepository, TechnologyRepository technologyRepository, TaskRepository taskRepository) {
